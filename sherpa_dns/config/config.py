...
class Config(BaseModel):
    ...
    def _flatten_config(config_data: dict) -> dict:
        ...
        flat_config["cloudflare_proxied_by_default"] = cloudflare.get("proxied_by_default", False)
        ...
        flat_config["txt_wildcard_replacement"] = registry.get("txt_wildcard_replacement", "*")
